...
var VisibilityToggle = function (_React$Component) {
  ...
  function VisibilityToggle(props) {
    ...
    _this.onShowOrHideText = _this.onShowOrHideText.bind(_this);
    return _this;
  }

  _createClass(VisibilityToggle, [{
    key: 'onShowOrHideText',
    value: function onShowOrHideText() {
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          ...
          null,
          'Current Visibility: ',
          this.state.visibility.toString()
        ),
        React.createElement(
          'button',
          { onClick: this.onShowOrHideText },
