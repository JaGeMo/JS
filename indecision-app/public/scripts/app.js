...
var IndecisionApp = function (_React$Component) {
  ...
  function IndecisionApp(props) {
    ...
    _this.handleDeleteIOptions = _this.handleDeleteIOptions.bind(_this);
  ...
  _createClass(IndecisionApp, [{
    ...
    key: "handleDeleteIOptions",
    value: function handleDeleteIOptions() {
      // function that needs to be transferred to child components to update parent's state props
...
var Options = function (_React$Component4) {
  ...
  _createClass(Options, [{
    key: "render",
    value: function render() {
      var counter = this.props.options.length;
      return React.createElement(
        "div",
        null,
        React.createElement(
          ...
          React.createElement(
            "button",
            { onClick: this.props.handleDeleteIOptions },
            " remove all .. "
          ),
...
var AddOption = function (_React$Component6) {
  ...
  _createClass(AddOption, [{
    ...
    value: function handleAddOption(event) {
      ...
      var tmpVar = event.target.elements.option.value.trim();
      var error = this.props.handleAddNewOption(tmpVar);
